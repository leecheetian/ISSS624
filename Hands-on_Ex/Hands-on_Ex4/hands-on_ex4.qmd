...
This hands-on exercise demonstrates how **Geographically Weighted Regression (GWR)** can be used to build hedonic pricing models for condominium sales, taking into consideration non-stationary structural and locational variables such as climate, demographic factors, physical environment characteristics etc as independent variables, and finding their relationships with the dependent variable - the resale prices of condominiums in 2015.
